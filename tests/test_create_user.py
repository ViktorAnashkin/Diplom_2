...
class TestUserCreation:
    ...
    def test_create_unique_user(self, cleanup_user):
    ...
    def test_create_existing_user(self, registered_user, cleanup_user):
    ...
    def test_create_user_missing_field(self, missing_field, user_data, expected_message, cleanup_user):
